...
public class SelectorTest {
   ...
   */
   ...
   public void noCeilingTest() {
      Selector.<Integer>ceiling(a3, 100, new CompareIntByStdOrder());
   }
   ...
   */
   ...
   public void middleCeilingTest() {
      Assert.assertEquals("Middle average ceiling failed.",
             Selector.<Integer>ceiling(a2, 3, new CompareIntByStdOrder()), (Integer) 4);
   }
   ...
   */
   @Test
   public void minCeilingTest() {
      Assert.assertEquals("Boundary condition of min three values" +
             " in array failed",
             Selector.<Integer>ceiling(a2, 0, new CompareIntByStdOrder()), (Integer) 1);
   }
   ...
   */
   @Test
   public void maxCeilingTest() {
      Assert.assertEquals("Boundary condition of max three values" +
             " in array failed.",
             Selector.<Integer>ceiling(a2, 8, new CompareIntByStdOrder()), (Integer) 9);
   }
   ...
   */
   @Test
   public void ceilingSingleTest() {
      ArrayList<Integer> single = new ArrayList<Integer>();
      single.add(2);
      Assert.assertEquals("Failed single element boundary case",
             Selector.<Integer>ceiling(single, 2, new CompareIntByStdOrder()), (Integer) 2);
   }
   ...
   */
   @Test
   public void ceilingTwoFirstTest() {
      ArrayList<Integer> two = new ArrayList<Integer>();
      two.add(2);
      two.add(1);
      Integer expected = 2;
      Assert.assertEquals("Failed two element 1st range case",
             Selector.<Integer>ceiling(two, 2, new CompareIntByStdOrder()), expected);
   }
   ...
   */
   @Test
   public void ceilingTwoSecondTest() {
      ArrayList<Integer> two = new ArrayList<Integer>();
      two.add(2);
      two.add(1);
      Integer expected = 1;
      Assert.assertEquals("Failed two element 2nd range case",
             Selector.<Integer>ceiling(two, 0, new CompareIntByStdOrder()), expected);
   }
   ...
   */
   @Test
   public void ceilingDupTest() {
      Integer expected = 7;
      Assert.assertEquals("Same high low test.",
             Selector.<Integer>ceiling(a5, 6, new CompareIntByStdOrder()), expected);
   }
}
